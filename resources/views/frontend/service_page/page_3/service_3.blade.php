...
@section('title', 'Blood Pressure Check - SusthoCare')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="service-image-box">
                        <img src="{{ asset('uploads/images/service-page/S4.png') }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="service-info-card">
                        ...
                        <div class="service-desc">
                            Quick and accurate blood pressure monitoring to assess heart health and hypertension risk.
                        </div>
                    </div>
