...
@section('title', 'Blood Sugar Test - SusthoCare')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="service-image-box">
                        <img src="{{ asset('uploads/images/service-page/S1.png') }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="service-info-card">
                        ...
                        <div class="service-desc">
                            Measures glucose level in blood to diagnose diabetes and monitor sugar control.
                        </div>
                    </div>
