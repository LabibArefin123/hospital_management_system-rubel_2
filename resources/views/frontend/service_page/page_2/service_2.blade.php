...
@section('title', 'X-Ray Scan - SusthoCare')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="service-image-box">
                        <img src="{{ asset('uploads/images/service-page/S6.png') }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="service-info-card">
                        ...
                        <div class="service-desc">
                            Digital X-ray imaging for bone, chest, and internal structure diagnosis with high accuracy.
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="summary-card">
                        ...
                        <div class="summary-row total">
                            <span>Total</span><span>৳1500</span>
                        </div>
