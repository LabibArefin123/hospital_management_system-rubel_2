...
@section('title', 'Full Blood Count - SusthoCare')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="service-image-box">
                        <img src="{{ asset('uploads/images/service-page/S2.png') }}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="service-info-card">
                        <h3>Full Blood Count (CBC)</h3>

                        <div class="service-desc">
                            Comprehensive blood analysis to check infection, anemia, and overall health condition.
                        </div>
                    </div>
